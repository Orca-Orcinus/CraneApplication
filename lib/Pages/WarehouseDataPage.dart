...
//     // Avoid concurrent sync attempts
//     if (_syncing) return;
//     setState(() => _syncing = true);
//     final svc = SyncService(db, FireStoreService());
//     ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Syncing warehouse data...')));
//     try {
//       await svc.syncAll();
//       // make sure UI reloads from DB after changes
//       setState(() {});
//       ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Warehouse sync finished')));
//     } catch (e) {
...
//                           onRefresh: () async {
//                             // Pull/push sync when user pulls to refresh
//                             await _syncOnLoad();
//                             // After sync finishes, ensure refreshed UI
//                             await _getFilteredWarehouses();
//                           },
...
//                   initialValue: orderStatusController.text,
//                   decoration:
...
//                 const SizedBox(height: 12),
//                 DropdownButtonFormField<String>(
//                   initialValue: deliveryStatusController.text,
//                   decoration:
...
//                 const SizedBox(height: 12),
//                 DropdownButtonFormField<String>(
//                   initialValue: paymentStatusController.text,
//                   decoration:
